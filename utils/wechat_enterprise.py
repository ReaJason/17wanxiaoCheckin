...
def wechat_enterprise_push(corp_id, corp_secret, agent_id, to_user, msg):
    ...
    try:
        ...
        if not res["errcode"]:
            ...
            return {
                "status": 0,
                "errmsg": "不合法的 secret 参数，https://open.work.weixin.qq.com/devtool/query?e=40001",
            }
        elif res["errcode"] == 40013:
            return {
                "status": 0,
                "errmsg": "不合法的 CorpID，https://open.work.weixin.qq.com/devtool/query?e=40013",
            }
        else:
    ...
    try:
        ...
        if not res["errcode"]:
            ...
            return {
                "status": 0,
                "errmsg": "不合法的 agentid，https://open.work.weixin.qq.com/devtool/query?e=40056",
            }
