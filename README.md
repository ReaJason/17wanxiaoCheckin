...
&emsp;&emsp;本项目使用了 `requests`、`pycryptodome` 第三方库，2.0 版本迎来项目重构，打卡数据错误修改方法，不再是以前的修改代码（不懂代码容易改错或无法下手），而是通过直接修改配置文件即可。
...
* [x] 支持邮箱（**推荐**）、[Qmsg](https://qmsg.zendee.cn/index.html)、[Server 酱](https://sct.ftqq.com/)、[PipeHub](https://www.pipehub.net/)、[企业微信](https://work.weixin.qq.com/) 推送打卡消息
